...
let mk_ddebug_stats_output f =
  "-ddebug-stats-output", Arg.String f,
  "<file>  Set output filename for debug stats data"
;;
...
struct
  let list = [
    ...
    mk_ddebug_stats_output F._ddebug_stats_output;
...
module Default = struct
  ...
  module Compiler = struct
    ...
    let _ddebug_stats_output s = debug_stats_output_name := Some s
