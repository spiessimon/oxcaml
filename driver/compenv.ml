...
let read_one_param ppf position name v =
  ...
  | "inline-max-depth" ->
    Int_arg_helper.parse v
      ...
      inline_max_depth
  | "gdwarf-precision-shape-reduce-depth" ->
    int_setter ppf "gdwarf-precision-shape-reduce-depth" gdwarf_precision_shape_reduce_depth v
  | "gdwarf-precision-shape-eval-depth" ->
    int_setter ppf "gdwarf-precision-shape-eval-depth" gdwarf_precision_shape_eval_depth v
  | "gdwarf-precision-max-cms-files-per-unit" ->
    int_setter ppf "gdwarf-precision-max-cms-files-per-unit" gdwarf_precision_max_cms_files_per_unit v
  | "gdwarf-precision-max-cms-files-per-variable" ->
    int_setter ppf "gdwarf-precision-max-cms-files-per-variable" gdwarf_precision_max_cms_files_per_variable v
