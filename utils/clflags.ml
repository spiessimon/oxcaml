...
and gdwarf_precision_shape_reduce_depth = ref 1_000_000_000    (* -gdwarf-precision-shape-reduce-depth *)
and gdwarf_precision_shape_eval_depth = ref 5       (* -gdwarf-precision-shape-eval-depth *)
and gdwarf_precision_max_cms_files_per_unit = ref 20  (* -gdwarf-precision-max-cms-files-per-unit *)
and gdwarf_precision_max_cms_files_per_variable = ref 1_000_000_000  (* -gdwarf-precision-max-cms-files-per-variable *)
