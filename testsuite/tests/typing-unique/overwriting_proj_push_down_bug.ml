   ...
   proj_unique/305 =
     (function {nlocal = 0} r/307[(consts ()) (non_consts ([0: *, *]))]
       ...
       (let
         ...
         (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/309 y/308))))
   ...
   match_unique/316 =
     (function {nlocal = 0} r/318[(consts ()) (non_consts ([0: *, *]))]
       ...
       (let
         ...
         (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/320 y/319))))
   ...
   match_mini_anf_aliased/322 =
     (function {nlocal = 0} r/324[(consts ()) (non_consts ([0: *, *]))]
       ...
       (let
         ...
         (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/327
           (field_imm 1 r/324)))))
   ...
   match_mini_anf_unique/332 =
     (function {nlocal = 0} r/334[(consts ()) (non_consts ([0: *, *]))]
       ...
       (let
          ...
          *match*/340 =[int] 1
          r/337 =[(consts ()) (non_consts ([0: *, *]))]
            (apply unique_use/297 r/334))
         (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/337 y/336))))
     ...
     (function {nlocal = 0} r/344[(consts ()) (non_consts ([0: *, *]))]
       ...
       (catch
         (let (y/346 =a (field_imm 1 r/344))
           (if (== y/346 "") (let (*match*/353 =[int] 0) (exit 8 y/346))
             (let (*match*/351 =[int] 1) (exit 8 (field_imm 1 r/344)))))
        with (8 y/345)
         (let
...
(let
  (unique_use/297 = (apply (field_imm 0 (global Toploop!)) "unique_use")
   match_anf_unique/354 =
     (function {nlocal = 0} r/356[(consts ()) (non_consts ([0: *, *]))]
       [(consts ())
        (non_consts ([0: [(consts ()) (non_consts ([0: *, *]))], *]))]
       (catch
         (let (y/358 =o (field_mut 1 r/356))
           (if (== y/358 "") (let (*match*/365 =[int] 0) (exit 14 y/358))
             (let (y/359 =o (field_mut 1 r/356) *match*/363 =[int] 1)
               (exit 14 y/359))))
        with (14 y/357)
         (let
           (r/360 =[(consts ()) (non_consts ([0: *, *]))]
              (apply unique_use/297 r/356))
           (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/360
             y/357)))))
...
(let
  (unique_use/297 = (apply (field_imm 0 (global Toploop!)) "unique_use")
   aliased_use/294 = (apply (field_imm 0 (global Toploop!)) "aliased_use")
   match_guard/390 =
     (function {nlocal = 0} r/392[(consts ()) (non_consts ([0: *, *]))]
       [(consts ())
        (non_consts ([0: [(consts ()) (non_consts ([0: *, *]))], *]))]
       (let (y/393 =o (field_mut 1 r/392))
         (if (apply (field_imm 8 (global Stdlib__String!)) y/393 "")
           (let
             (r/464 =[(consts ()) (non_consts ([0: *, *]))]
                (apply aliased_use/294 r/392))
             (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/464
               y/393))
           (let
             (y/394 =o (field_mut 1 r/392)
              r/465 =[(consts ()) (non_consts ([0: *, *]))]
                (apply unique_use/297 r/392))
             (makeblock 0 ([(consts ()) (non_consts ([0: *, *]))],*) r/465
               y/394))))))
